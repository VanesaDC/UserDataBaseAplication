...
class UserManagerTest {
    ...
    @Test
    void upDateUser_should_throw_a_exception_when_the_dni_is_not_registered() throws DniException, NameException, AgeException, EmailException,MySqlRepositoryException {
    ...
    @Test
    void upDateUser_should_update_user_when_it_is_registered() throws DniException, NameException, AgeException, EmailException, MySqlRepositoryException {
    ...
    @Test
    void deleteUser_should_delete_user_when_it_is_registered() throws DniException, NameException, AgeException, EmailException, MySqlRepositoryException {
        dni = Dni.createDni("45456869Z");
        name = Name.createName("Juliana");
        age = Age.createAge("34");
        email = Email.createEmail("email@gmail.com");
    ...
    @Test
    void deleteUser_should_throws_esception_when_user_it_is_not_registered() throws DniException, NameException, AgeException, EmailException, MySqlRepositoryException {
        dni = Dni.createDni("45456869Z");
        name = Name.createName("Juliana");
        age = Age.createAge("34");
        email = Email.createEmail("email@gmail.com");
